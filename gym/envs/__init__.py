...
register(
    ...
    entry_point='gym.envs.classic_control:CartPoleCustomEnv',
    max_episode_steps=200,
    reward_threshold=195.0,
)
...
register(
    ...
    entry_point='gym.envs.classic_control:MountainCarCustomEnv',
    max_episode_steps=200,
    reward_threshold=-110.0,
)
...
register(
    ...
    entry_point='gym.envs.classic_control:Continuous_MountainCarCustomEnv',
    max_episode_steps=999,
    reward_threshold=90.0,
)
